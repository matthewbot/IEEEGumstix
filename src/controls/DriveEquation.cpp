...
DriveEquation::Output DriveEquation::compute(const Motion &motion) const {
	Output out;
...
DriveEquation::WheelOutput DriveEquation::computeWheel(const WheelConfig &wconfig, const Motion &motion) const {
	Vec2D wheelout;
