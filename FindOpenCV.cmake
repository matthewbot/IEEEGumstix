...
if (NOT "${OpenCV_DIR}" AND ${CMAKE_SYSTEM_NAME} MATCHES "Linux")
	set(OpenCV_DIR /usr)
endif(NOT "${OpenCV_DIR}" AND ${CMAKE_SYSTEM_NAME} MATCHES "Linux")
...
if(EXISTS "${OpenCV_DIR}")
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
                ...
                find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" "${__CVLIB}d" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}${CVLIB_SUFFIX}" "${__CVLIB}" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
